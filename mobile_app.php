...
<div id="signupModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:1000; justify-content:center; align-items:center;">
  <div style="background:#fff; padding:20px; border-radius:8px; position:relative; width:90%; max-width:400px; margin:auto;">
    <span onclick="closeSignupModal()" style="position:absolute; top:10px; right:10px; cursor:pointer; font-size:1.2rem; color:#222;">&times;</span>
    <iframe id="signupFrame" src="" style="width:100%; border:none; height:500px;"></iframe>
  </div>
</div>
